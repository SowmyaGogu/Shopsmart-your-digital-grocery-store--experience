...
const deleteData = (taskId) => {
    axios.delete(`http://localhost:5200/userdelete/${taskId}`);
    window.location.assign('/admin/users');
    alert('User is deleted');
  };
  const deleteorder = (taskId) => {
    axios.delete(`http://localhost:5200/userbookingdelete/${taskId}`);
    window.location.assign('/admin/users');
    alert('deleted');
  };
  ...
  const fetchUserBikeData = (userId) => {
    ...
    axios.get(`http://localhost:5200/getbookings/${userId}`)
